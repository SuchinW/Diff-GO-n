...
class TrainLoop:
    ...
    def run_loop(self):
        while (
            ...
            cond = self.preprocess_input(cond, one_hot_label=self.one_hot_label, add_noise=self.add_noise, noise_to=self.noise_to,image=batch)
    ...
    def preprocess_input(self, data, one_hot_label=True, add_noise=False, noise_to="semantics",image=None):
        # move to GPU and change data types
        data['label'] = data['label'].long()

        if image is not (None):
            # vutils.save_image(image, "instantEdgeMap.png")
        ...
        if one_hot_label:
            ...
            if 'instance' in data:
                ...
                # vutils.save_image(instance_edge_map, "instwithedge.png")
                # R
